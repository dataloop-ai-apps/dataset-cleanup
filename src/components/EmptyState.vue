<template>
    <div>
        ...
        <div v-if="showProgress" class="base-container-f14">
            ...
            />
            <DlTypography> Status: {{ FrontendStatus[latestStatus] }} </DlTypography>
        </div>
    </div>
</template>

<script setup lang="ts">
import { DlTypography, DlButton, DlIcon, DlProgressBar } from '@dataloop-ai/components'
import { defineProps, withDefaults } from 'vue'
import { ref, onMounted, computed, defineEmits } from 'vue-demi'
